...
Unser Quarkus\ref{quarkus} Backend hat die Aufgabe mit Rasa X\ref{rasax} zu kommunizieren und die Konversationsdaten für das Dashboard aufzubereiten und zu senden.

Unser Backend besitzt folgende Enpoints:
...
Der Leobot Conversation Cycle ist ein Worflow der dazu dient, den Leobot zu überprüfen und zu erweitern.

Der Worflow besteht aus folgenden Schritten:
