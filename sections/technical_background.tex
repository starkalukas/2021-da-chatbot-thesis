...
Zurzeit haben wurde der Kontext von Wörtern in einem Satz neben dem zu analysierenden Wort ignoriert.
Tatsächlich tragen die Wortnachbarn viel zur Bedeutung eines Wortes bei.
...
Sobald man allerdings die korrekte Antwort definiert hat, kann es sein, dass beim nächsten Mal, wenn man dies nachschlägt bereits die richtige Antwort bekommt.
...
In Vektorenschreibweise kommt man dabei auf den Vektor der \texttt{Seattle Sounders} ~\ref{fig:compute-word2vec}.\cite{nlpInAction}
